$(function(){
	...
	if(result.isSuessful){
		
		htmlStr=`
			    <li><a href="../personal.php?index=3"fa fa-user"></span> 小强</a></li>
		...
		htmlStr=`
				<li><a href="../login.php"fa fa-user"></span> 立即登录</a></li>
	...
	$("#main_Menu ul li").eq(index).addClass("active").siblings().remove("article");
